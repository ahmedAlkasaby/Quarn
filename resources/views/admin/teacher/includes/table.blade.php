        ...
        <div class="card-header d-flex flex-wrap py-0 flex-column flex-sm-row justify-content-between mt-4 mb-4">
            <div class="me-5 ms-n2 pe-5">
                <div class="dataTables_filter">
                    <form action="{{ route('teachers.index')}}" method="get" class="d-flex align-admins-center">
            ...
            <tbody>
                ...
                <tr class="{{ $loop->iteration % 2 == 0 ? 'even' : 'odd' }}">
                    ...
                    <td class="text-nowrap text-sm-center">
                        <button type="button" class="btn btn-primary" {{ $teacher->circles->count() > 0 ? '' :
                            'disabled' }}>
                            <a href="{{ route('circles.index', ['teacher_id' => $teacher->id]) }}" class="text-white">
                                {{ $teacher->circles->count() }}
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    ...
                                    <a class="dropdown-item edit-btn" href="{{ route('teachers.edit', $teacher->id) }}">
                ...
                @include('admin.includes.model.delete',["id"=>$teacher->id,"main_name"=>"teachers","name"=>"teacher"])
                @endforeach
                @else
                <tr>
